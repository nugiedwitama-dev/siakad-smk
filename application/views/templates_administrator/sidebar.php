        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #198754;">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('administrator/ruangan')?>">Ruangan</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage"
                    ...
                    <span class="text-light">Info</span>
                </a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <a class="sidebar-brand justify-content-center mt-2 d-flex" href="<?= base_url('administrator/dashboard') ?>">
                        ...
                        <span style="color: #000;">SMK SEMAK SEMAK</span> </strong></div>
                    </a>
                    </center>
