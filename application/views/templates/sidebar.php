        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #198754;">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span class="text-light">Akademik</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('administrator/tahun_ajaran')?>">Tahun Ajaran</a>
                        <a class="collapse-item" href="<?= base_url('administrator/jadwal')?>">Jadwal</a>
                        <a class="collapse-item" href="<?= base_url('administrator/input_nilai')?>">Input Nilai</a>
                        <a class="collapse-item" href="<?= base_url('administrator/raport')?>">Raport</a>
                        <a class="collapse-item" href="<?= base_url('administrator/cetak_nilai')?>">Cetak Nilai</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <span class="text-light">Presensi</span>
                </a>
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Sub-Menu Presensi:</h6>
                        <a class="collapse-item" href="register.html">SCAN PRESENSI</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage"
                    ...
                    <span class="text-light">Info Kampus</span>
                </a>
                <div id="collapsePage" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="blank.html">Tentang Sekolah</a>
                        <a class="collapse-item" href="404.html">Fasilitas</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <center><img src="<?= base_url('assets/uploads/logo-dewantara.png')?>" width="70px" height="70px"></center>

                    <!-- Topbar Search -->
                    <center>
                    <a class="sidebar-brand justify-content-center mt-2 d-flex" href="<?= base_url('administrator/dashboard') ?>">
                        <div class="sidebar-brand-icon">
                        </div>
                        <div class="sidebar-brand-text mx-1"><strong style="color:#198754"> SIS
                        <span style="color: #000;">SMK DEWANTARA SUMBANG</span> </strong></div>
                    </a>
                    </center>
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-5 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn" style="background-color: #198754;" type="button">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= base_url('assets/uploads/').$photo; ?>">
                            </a>
